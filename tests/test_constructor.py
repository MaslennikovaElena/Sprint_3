...
def test_constructor_to_bread_success(web_driver):
    ...
    assert web_driver.find_element(By.XPATH, ConstructorLocator.BREAD_HEADER_XPATH).is_displayed()
...
def test_constructor_to_sause_success(web_driver):
    ...
    assert web_driver.find_element(By.XPATH, ConstructorLocator.SAUSE_HEADER_XPATH).is_displayed()
...
def test_constructor_to_filling_success(web_driver):
    ...
    assert web_driver.find_element(By.XPATH, ConstructorLocator.FILLING_HEADER_XPATH).is_displayed()
