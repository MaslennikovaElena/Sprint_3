...
from locators import MAIN_CABINET_BTN_XPATH, PAGE_MAIN, PAGE_CABINET, \
    CABINET_CONSTRUCTOR_BTN_XPATH, CABINET_SITE_LOGO_XPATH, PAGE_LOGIN, CABINET_LOGOUT_BTN_XPATH
